package com.hirevo.security.crypto;
 ...
 * Shared across services (iam-service for TOTP secrets, employee-service for NIK/NPWP, etc.)
 * so encryption never gets copy-pasted and drifts.
 *
...
public class FieldEncryptor {
  ...
  /** Convenience for masking a decrypted value in API responses (e.g. NIK "32**********"). */
  public static String maskKeepLast(String value, int keepLast) {
    if (value == null || value.length() <= keepLast) return value;
